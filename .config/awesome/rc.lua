...
mymainmenu = freedesktop.menu.build({
    ...
    before = {
        {"Awesome", myawesomemenu, beautiful.awesome_icon} -- { "Atom", "atom" },
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup{
        ...
        s.mytasklist, -- Middle widget
        {
            ...
            cpu_widget({enable_kill_button = true, timeout = 1}),
...
globalkeys = gears.table.join( -- awesome features
                 awful.key({modkey}, "s", hotkeys_popup.show_help,
                           {description = "show help", group = "awesome"}), -- awful.key({modkey}, "w", function()
    --     mymainmenu:show()
    -- end, {
    ...
    -- }),
        ...
        awful.prompt.run {
            ...
            history_path = awful.util.get_cache_dir() .. "/history_eval"
                 ...
                 awful.key({"Control", "Mod1"}, "l",
                           ...
                           {description = "lock screen", group = "awesome"}), -- Change focus
    ...
    end, {description = "focus the previous screen", group = "screen"}), -- view tags
        ...
        if client.focus then client.focus:raise() end
    end, {description = "go back", group = "client"}), -- Layout manipulation
    ...
    end, {description = "Show Desktop", group = "launcher"}), -- Launcher
    awful.key({modkey}, "t", function() awful.spawn(terminal) end,
              {description = "open a terminal", group = "launcher"}),
                 ...
                 awful.key({"Control", "Shift"}, "Escape",
                           function() awful.spawn("plasma-systemmonitor") end, {
        ...
        awful.spawn("dolphin")
                 ...
                 awful.key({modkey}, "KP_Left",
                           function() awful.spawn("qqmusic") end, {
        ...
        group = "launcher"
                 ...
                 awful.key({modkey}, "KP_Insert",
                           function() awful.spawn("discord") end,
                           {description = "launch discord", group = "launcher"}), -- Screenshots
...
end, {description = "move to master", group = "client"}), -- awful.key({ modkey }, "t", function(c) c.ontop = not c.ontop end,
...
-- 		{ description = "(un)maximize horizontally", group = "client" }),
...
end, {description = "minimize", group = "client"}), awful.key({modkey}, "Left",
                                                              function()
    awful.client.swap.global_bydirection("left")
end, {description = "swap with left", group = "client"}),
                              awful.key({modkey}, "Right", function()
    awful.client.swap.global_bydirection("right")
end, {description = "swap with right", group = "client"}), -- move client to tag
...
end, {description = "send focused client to next tag", group = "tag"}), -- move client to screen
    ...
    -- end
                              ...
                              awful.key({}, "XF86AudioMute",
                                        function() volume_widget:toggle(2) end), -- Media Keys
...
end), awful.button({modkey}, 4, function() awful.tag.viewprev() end),
...
awful.rules.rules = { -- All clients will match this rule.
    ...
    }, {rule = {instance = "krunner"}, properties = {floating = true}}, -- Floating clients.
    {
        rule_any = {
            instance = {
